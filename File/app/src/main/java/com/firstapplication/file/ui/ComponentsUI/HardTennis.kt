...
/*
@Composable
fun HardTennis(navHostController: NavHostController)
{
            ...
            Text(
                text = buildAnnotatedString {
                    withStyle(
                        ...
                        append("Explore Recommended Sizes of Hard Tennis Bats\n\n")
                    }
                },
            ...
            Box(
                ...
                Column(
                    ...
                    LazyColumn(
                        ...
                        item {
                            Image(
                                painter = painterResource(id = R.drawable.hardtennis),
                    ...
                    LazyColumn(
                        ...
                        item {
                            ...
                            Box(
                                ...
                                Image(
                                    painter = painterResource(id = R.drawable.hardtennis),
                                    contentDescription = "Hard Tennis",
                                    contentScale = ContentScale.Fit, // Ensure image scales correctly
